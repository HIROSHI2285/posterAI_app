...
## 料金体系・モデル移行計画 (v1.6.0予定)

**🚀 次期バージョン：Gemini 3.1 API Suiteへの完全移行 (2026年3月)**
2026年3月の旧Previewモデル群廃止を受け、全システムを **Gemini 3.1 API Suite** に移行します。新しいハイブリッド構成により、最高品質を維持しつつ**テキスト編集・連続編集時のAPIコストを最大90%以上削減**します。

### Gemini 3.1 移行による圧倒的なコスト削減効果
- **画像生成**: `gemini-3.1-flash-image-preview` (Nano Banana 2) を採用し、4K解像度で旧Pro以上のクオリティをFlash価格で実現（旧モデルから約80%減）。
