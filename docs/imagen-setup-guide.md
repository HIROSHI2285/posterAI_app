# Google Cloud Imagen 3 セットアップガイド

## 🎯 Imagen 3 とは

**Imagen 3** は、Googleの最新テキストから画像を生成するAIモデルです。高品質なポスター、イラスト、写真風の画像を生成できます。
...
### Imagen 3 料金（2024年12月時点）

| 機能 | 料金 |
|------|------|
| **画像生成（1024x1024以下）** | $0.040 / 画像 |
| **画像生成（1024x1024超）** | $0.080 / 画像 |
| **画像編集** | $0.060 / 画像 |

### 無料トライアル

- **$300 のクレジット**（90日間有効）
- これで約 **7,500枚の画像**（1024x1024）を生成可能
- クレジット消費後は自動で課金開始
