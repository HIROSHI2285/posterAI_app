                ...
                <div className="space-y-24">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center group">
                        <div className="order-2 lg:order-1 relative">
                            ...
                            <BrowserFrame
                                src="/samples/real_standard_usage.png?v=6"
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center group">
                        ...
                        <div className="relative">
                            ...
                            <BrowserFrame
                                src="/samples/real_ref_usage.png?v=6"
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                    ...
                    <div className="bg-[#0f1014] border border-white/10 rounded-2xl p-6 hover:border-purple-500/30 transition-colors group">
                        <div className="mb-6 overflow-hidden rounded-lg border border-white/5 relative aspect-video">
                            <Image
                                src="/samples/real_edit_prompt.png?v=6"
                                alt="Prompt Editing"
                                fill
                                className="object-cover"
                            />
                    ...
                    <div className="bg-[#0f1014] border border-white/10 rounded-2xl p-6 hover:border-purple-500/30 transition-colors group">
                        <div className="mb-6 overflow-hidden rounded-lg border border-white/5 relative aspect-video">
                            <Image
                                src="/samples/real_edit_rect.png?v=6"
                                alt="Region Editing"
                                fill
                                className="object-cover"
                            />
                    ...
                    <div className="bg-[#0f1014] border border-white/10 rounded-2xl p-6 hover:border-purple-500/30 transition-colors group">
                        <div className="mb-6 overflow-hidden rounded-lg border border-white/5 relative aspect-video">
                            <Image
                                src="/samples/real_edit_text.png?v=6"
                                alt="Text Editing"
                                fill
                                className="object-cover"
                            />
                    ...
                    <div className="bg-[#0f1014] border border-white/10 rounded-2xl p-6 hover:border-purple-500/30 transition-colors group">
                        <div className="mb-6 overflow-hidden rounded-lg border border-white/5 relative aspect-video">
                            <Image
                                src="/samples/real_edit_insert.png?v=6"
            ...
            <section className="container mx-auto px-6 py-24 border-t border-white/5">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="order-2 lg:order-1 relative">
                        ...
                        <BrowserFrame
                            src="/samples/real_save_project.png?v=6"
                            alt="Project Saving"
                        />
                    </div>
                    <div className="order-1 lg:order-2 space-y-6">
