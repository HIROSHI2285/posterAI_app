            ...
            <header className="border-b border-white/10 bg-black/20 backdrop-blur-md sticky top-0 z-50">
                <div className="container mx-auto px-4 py-3 md:py-4 flex items-center justify-between">
                    ...
                    {session ? (
                        <Button
                            asChild
                            className="bg-green-500 hover:bg-green-600 text-white font-semibold shadow-lg px-4 md:px-6 text-sm md:text-base"
                        >
                        ...
                        <Button
                            ...
                            className="bg-green-500 hover:bg-green-600 text-white font-semibold shadow-lg px-4 md:px-6 flex items-center gap-2 text-sm md:text-base"
                        >
                            <span className="w-5 h-5 md:w-6 md:h-6 bg-white rounded-full flex items-center justify-center p-0.5 md:p-1">
